...
public final class CommonConstant {
  ...
  public static final String ROW_ELEMENT_VALUE = "#banggia-khop-lenh-body tr";

  public static final String SYMBOL_ELEMENT_VALUE = "td.txtl.has-tooltip.company-tooltip a.symbol";

  public static final String PRICE_ELEMENT_VALUE = "td.cell-highlight span[id$='matchP']";
